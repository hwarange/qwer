...
if __name__ == '__main__':
    ...
    if configs.get('nni'):
        ...
        configs.update({'embedding_dim': nni_params.get('embedding_dim')})
        configs.update({'learning_rate': nni_params.get('learning_rate')})
        configs.update({'dropout_ratio': nni_params.get('dropout_ratio')})
        configs.update({'lstm_hidden_dim1': nni_params.get('lstm_hidden_dim1')})
        configs.update({'lstm_hidden_dim2': nni_params.get('lstm_hidden_dim2')})
        configs.update({'linear_hidden_dim1': nni_params.get('linear_hidden_dim1')})
        configs.update({'linear_hidden_dim2': nni_params.get('linear_hidden_dim2')})
        configs.update({'window_size': nni_params.get('window_size')})
